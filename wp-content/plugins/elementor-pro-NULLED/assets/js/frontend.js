...
},{"modules/countdown/assets/js/frontend/frontend":2,"modules/forms/assets/js/frontend/frontend":7,"modules/posts/assets/js/frontend/frontend":12,"modules/share-buttons/assets/js/frontend/frontend":16,"modules/slides/assets/js/frontend/frontend":18}],2:[function(require,module,exports){
...
module.exports = elementorFrontend.Module.extend( {
	...
	onSectionShow: function( sectionName, editor ) {
		...
		if ( editor.getOption( 'editedElementView' ).model.cid !== self.getModelCID() ) {
			return;
		}
...
},{"./handlers/cards":13,"./handlers/portfolio":14,"./handlers/posts":15}],13:[function(require,module,exports){
...
},{"./posts":15}],14:[function(require,module,exports){
var PostsHandler = require( './posts' );
...
},{"./posts":15}],15:[function(require,module,exports){
module.exports = elementorFrontend.Module.extend( {
	getElementName: function() {
		return 'posts';
	},
...
},{"./handlers/share-buttons":17}],17:[function(require,module,exports){
...
},{"./handlers/slides":19}],19:[function(require,module,exports){
module.exports = function( $scope, $ ) {
